<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		$sql = "UPDATE users SET user_password = '$hashed_new_password' WHERE user_id = '$user_id' && user_password = '$hashed_current_password'";	
...
<body style="background: #f3f3f2;">
    ...
    <section style="background: #164428;padding-top: 40px;padding-bottom: 40px;">
        <div class="container">
            <div class="card" style="background: #f3f3f2;padding-bottom: 10px;">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h2 style="text-align: center;"><?php echo $_SESSION["user_id"] ?></h2>
                            <h4 style="text-align: center;"><?php echo $_SESSION["user_surname"] ?>, <?php echo $_SESSION["user_given_name"] ?></h4>
                            <h5 style="text-align: center;"><span><?php echo $_SESSION["user_balance"] ?></span></h5>
                            <hr>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                            <div>
                                <ul class="list-unstyled">
                                    <li style="text-align: center;"><input type="text" disabled="" value="<?php echo $_SESSION["user_id"] ?>" style="text-align: center;width: 60%;background: #ffffff;"></li>
                                    <li style="text-align: center;"><label class="form-label">ID Number&nbsp;</label></li>
                                    <li style="text-align: center;"><input type="text" disabled="" value="<?php echo $_SESSION["user_surname"] ?>" style="text-align: center;width: 60%;background: #ffffff;"></li>
                                    <li style="text-align: center;"><label class="form-label">Surname</label></li>
                                    <li style="text-align: center;"><input type="text" disabled="" value="<?php echo $_SESSION["user_given_name"] ?>" style="text-align: center;width: 60%;background: #ffffff;"></li>
                                    <li style="text-align: center;"><label class="form-label">Given Name</label></li>
                                    <li style="text-align: center;"><input class="text-capitalize" type="text" disabled="" style="text-align: center;width: 60%;background: #ffffff;" value="<?php echo $_SESSION["user_status"] ?>"></li>
                                    <li style="text-align: center;"><label class="form-label">Status</label></li>
                                    <li style="text-align: center;"><button class="btn btn-primary btn-sm" type="button" style="background: #10ae4d;border-style: none;" data-bs-target="#change-password" data-bs-toggle="modal">Change Password</button>
                                        <div class="modal fade" role="dialog" tabindex="-1" id="change-password">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="text-center" method="post">
                                                            <div class="mb-3"><input class="form-control" type="password" name="current_password" placeholder="Current Password" required="" minlength="8" maxlength="32"></div>
                                                            <div class="mb-3"><input class="form-control" type="password" name="new_password" placeholder="New Password" required="" minlength="8" maxlength="32"></div>
                                                            <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="background: #10ae4d; border-style:none">Change Password</button></div>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 overflow-scroll" style="height: 293px;overflow-x: hidden !important;">
<?php
	...
	$sql = "SELECT transaction_id, timestamp, amount, description FROM transactions WHERE user_id = '$user_id' ORDER BY timestamp DESC;";
	$transaction_history = mysqli_query($link, $sql);
	...
	while($row = mysqli_fetch_array($transaction_history))
	{
		...
		if ($row["amount"] < 0)
		{
			$formatted_amount = "- ₱" . number_format(($row["amount"] * -1), 2, '.', ',');
		}
		elseif ($row["amount"] == 0)
		{
		...
		echo '							<div class="card card-hover" style="border-radius: 0px;">
                                <div class="card-body">
                                    <h4 class="card-title">' . $row["description"] . '</h4>
									<h6 class="text-muted card-subtitle mb-2">' . $row["timestamp"] . '</h6>
                                    <h6 class="text-muted card-subtitle mb-2">' . $formatted_amount . '</h6>
                                </div>
                            </div>';
