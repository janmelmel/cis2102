...
<body style="background: #f3f3f2;">
        ...
        <div class="container-fluid"><a class="navbar-brand ms-auto" href="dashboard.php" style="font-weight: bold;">USC Library Portal</a><button data-bs-toggle="collapse" class="navbar-toggler ms-auto" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav d-none d-print-flex d-sm-none d-md-flex d-lg-flex d-xl-flex d-xxl-flex ms-auto">
                    <li class="nav-item"><a class="nav-link" style="font-weight: bold;text-align: center;"><span>' . $_SESSION["user_id"] . '</span>&nbsp;-&nbsp;<span>' . $_SESSION["user_surname"] . ', ' . $_SESSION["user_given_name"] . '</span>&nbsp;-&nbsp;<span>' . $_SESSION["user_balance"] . '</span></a></li>
                </ul>
	...
	<?php
		...
		while($row = mysqli_fetch_array($item))
		{
			...
			if ($row["availability"] !== "1" or $_SESSION["user_status"] !== "enrolled" or $_SESSION["balance_float"] < $row["price"])
			{
			...
			if ($row["availability"] !== "1" or $_SESSION["user_status"] !== "enrolled")
			{
			
				$availability_check2 = "disabled ";
			
			}
		
			echo '<section class="py-4 py-xl-5" style="background: #164428;">
        <div class="container">	
            <div class="bg-dark border rounded border-0 border-dark overflow-hidden">
                <div class="row g-0">
                    <div class="col-auto col-xl-6">
                        <div class="text-white p-4 p-md-5">
                            <h2 class="fw-bold text-white mb-3" style="text-align: center;"><strong>' . $row["title"] . '</strong><br></h2>
                            <h4 style="text-align: center;">by <span>' . $row["authors"] . '</span>&nbsp;(<span>2018</span>)</h4>
                            <hr style="margin-bottom: 0px;">
                            <div class="row">
                                <div class="col-xl-6 text-center" style="padding-left: 4px;margin-top: 16px;padding-right: 4px;">
                                    <h1 class="d-inline">₱' . number_format($row["price"], 2, '.', ',') . '</h1>
                                </div>
                                <div class="col-12 col-xl-6" style="padding-right: 4px;padding-left: 4px;text-align: center;margin-top: 16px;"><a class="btn btn-primary ' . $availability_check . 'btn-lg me-2" role="button" href="purchase-item.php?book_code=' . $book_code . '" style="background: #10ae4d;border-style: none;color: rgb(243,243,242);margin-bottom: 16px;margin-right: 4px !important;">Purchase</a><a class="btn btn-light ' . $availability_check2 . 'btn-lg" role="button" href="borrow-item.php?book_code=' . $book_code . '" style="background: #10ae4d;border-style: none;color: rgb(243,243,242);margin-bottom: 16px;margin-left: 4px !important;">Borrow</a></div>
                            </div>
                            <hr style="margin-top: 0px;">
                            <div class="overflow-scroll" style="max-height: 350px;padding-right: 8px;padding-left: 8px;overflow-x: hidden !important;">
                                <p class="mb-4" style="text-align: justify;">' . nl2br($row["description"]) . '</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-xl-6 order-first m-auto order-md-last" style="text-align: center;"><img class="img-fluid" src="assets/img/' . $book_code . '.jpg" style="max-height: 700px;"></div>
                </div>
            </div>
        </div>
    </section>';
