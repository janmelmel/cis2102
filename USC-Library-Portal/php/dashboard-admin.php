...
<body style="background: #f3f3f2;">
    <nav class="navbar navbar-light navbar-expand-md">
        <div class="container-fluid"><a class="navbar-brand ms-auto" href="dashboard-admin.php" style="font-weight: bold;">USC Library Portal (<span>admin</span>)</a><button data-bs-toggle="collapse" class="navbar-toggler ms-auto" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
			...
			<div class="container">
				...
				<div class="row gx-2 gy-2 row-cols-2 row-cols-md-5 row-cols-xl-5 photos" data-bss-baguettebox>
					<?php
						...
						$sql = 'SELECT book_code FROM library_transactions WHERE status = 3 GROUP BY  book_code ORDER BY COUNT(book_code) DESC';
